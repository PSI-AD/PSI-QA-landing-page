        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative z-10 text-left w-full">
          <div className="lg:w-1/2 flex flex-col justify-center">
            <ScrollReveal>
              ...
              <p className="text-base md:text-xl text-gray-500 dark:text-gray-400 mb-10 md:mb-12 max-w-xl font-medium leading-relaxed italic">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 md:mb-24 text-left">
            <ScrollReveal>
              ...
              <p className="text-gray-500 dark:text-gray-400 font-medium text-lg md:text-xl italic max-w-xl">Enterprise-grade tooling designed for highest-precision operations.</p>
            </ScrollReveal>
          </div>
          <FeatureBentoGrid />
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 md:mb-24 text-center">
            <ScrollReveal>
              ...
              <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 font-medium italic max-w-2xl mx-auto">Full-stack infrastructure and intelligence for global-scale reliability.</p>
            </ScrollReveal>
          </div>
          <GoogleProductionBento />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="text-left">
              <ScrollReveal>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-base md:text-lg font-medium mb-10 md:mb-12 italic leading-relaxed">
      ...
      <section className="py-24 md:py-44 px-6 md:px-8 bg-white dark:bg-[#0F111A]">
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 font-medium italic max-w-3xl mx-auto">Engineered for modularity, type-safety, and enterprise performance.</p>
          </ScrollReveal>
          <ScrollReveal delay={300}>
             <CodePipelineVisual />
          </ScrollReveal>
      ...
      <section className="py-24 md:py-44 px-6 md:px-8 bg-gray-50 dark:bg-[#0B0C14] border-t border-gray-100 dark:border-white/5">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal className="text-center mb-16 md:mb-24">
             ...
             <p className="text-gray-500 dark:text-gray-400 text-lg md:text-xl font-medium italic">Immutable history of every audit execution cycle.</p>
          </ScrollReveal>
          <DetailedTicketTable />
        </div>
      </section>
