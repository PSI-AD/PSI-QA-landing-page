          ...
          <div className="lg:w-1/2">
            <ScrollReveal>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-8">
                 <a href={DASHBOARD_URL} className="w-full sm:w-auto bg-slate-900 dark:bg-white dark:text-[#1F1F1F] text-white px-10 md:px-14 py-4 md:py-6 rounded-2xl font-black text-lg md:text-xl hover:scale-105 transition-all shadow-2xl text-center">
                   Analyze Metrics
                 </a>
                 <a href={DASHBOARD_URL} className="w-full sm:w-auto bg-white dark:bg-white/5 border-2 border-slate-200 dark:border-white/10 text-slate-500 dark:text-gray-300 px-10 md:px-12 py-4 md:py-6 rounded-2xl font-black text-lg md:text-xl hover:border-[#00c875] hover:text-[#00c875] transition-all text-center">
                   Start Sprint
                 </a>
              </div>
            </ScrollReveal>
